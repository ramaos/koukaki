...
<main id="primary" class="site-main">
    <section class="banner">
        ...
        <video src="wp-content/themes/foce-child/assets/video/video_banner.mp4" width="100%" autoplay muted loop></video>
    </section>
    <section id="histoire" class="histoire">
        ...
        <article id="characters">
            <?php get_template_part('template-parts/template', 'personnage'); ?>
        </article>
        <article id="place" class="place">
            ...
            <div>
                <h3><span class="animation-titre-place">Le Lieu</span></h3>
